...
INPUT_ON_XRD=0 # 0 for local files, 1 for xrd files
XRDSERV="root://eoscms.cern.ch/" # eos xrootd server, path should start /store/group...

# ============================================================
# NeNe data, PD1
# ============================================================
NAME="${DATE}_Skim_NeNe_IonPhysics4_AllPtV1_0716LynnTest_test"
PATHSAMPLE="/eos/cms/store/group/phys_heavyions/xirong/Run3_NeonRAA/PromptForest/IonPhysics0/crab_NeNe_IonPhysics0_AllPtV1_0716LynnTest/250716_180522/0000"
